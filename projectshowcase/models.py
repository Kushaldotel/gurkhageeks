...
class projectshowcase(models.Model):
    ...
    user = models.ForeignKey(
        user, on_delete=models.CASCADE, related_name="projectshowcase"
    )
...
class ProjectShowcaseImage(models.Model):
    project_showcase = models.ForeignKey(
        projectshowcase, on_delete=models.CASCADE, related_name="images"
    )
