    ...
    def create(self, request):
        ...
        if serializer.is_valid():
            ...
            html_message = render_to_string(
                "blog/confirmation_email.html", {"confirmation_link": conformation_link}
            )
            ...
            try:
                ...
                response_data = {"message": "Registration email sent for confirmation"}
                return Response(
                    {"status": response_data}, status=status.HTTP_201_CREATED
                )
...
class ForgotPassword(ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        html_message = render_to_string(
            "blog/forgotpassword.html", {"reset_link": reset_link}
        )
        plain_message = strip_tags(html_message)
        from_email = settings.EMAIL_HOST_USER
        send_mail(
...
class OrganisationRegistrationView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            return Response(
                {
                    "message": "Organization registered successfully. Verification is pending."
                },
