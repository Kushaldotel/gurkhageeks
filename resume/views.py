...
class ResumeFeedbackViewSet(ModelViewSet):
    ...
    parser_classes = [MultiPartParser]  # Use `parser_classes` instead of `pagination_class`
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            try:
                ...
                return Response({"error": "Poppler is not installed or not found. Please install it to proceed.", "details": str(e)}, status=500)
            except (PDFPageCountError, PDFSyntaxError) as e:
                return Response({"error": "There was an issue with processing the PDF file.", "details": str(e)}, status=400)
